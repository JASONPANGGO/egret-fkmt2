...
(function (com) {
    ...
    var LightMask = (function (_super) {
         ...
         * 显示遮罩
         */
        LightMask.prototype.show = function () {
            this.visible = true;
        };
        /**
         * 隐藏遮罩
         */
        LightMask.prototype.hide = function () {
            this.visible = false;
        };
        /**
         * 设置光圈的大小
         ...
         */
        LightMask.prototype.setLightSize = function (width, type, height) {
            ...
            if (type == 1) {
                this.cirleLight.graphics.drawRect(0, 0, width, height);
            }
            else {
         ...
         */
        LightMask.prototype.setMaskSize = function (maskW, maskH, maskA) {
    ...
    com.LightMask = LightMask;
    __reflect(LightMask.prototype, "com.LightMask");
})(com || (com = {}));
//# sourceMappingURL=LightMask.js.map